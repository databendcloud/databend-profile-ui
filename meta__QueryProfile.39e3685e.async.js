"use strict";(self.webpackChunkdatabend_profile_ui=self.webpackChunkdatabend_profile_ui||[]).push([[152],{25840:function(An,G,l){l.r(G),l.d(G,{demos:function(){return On}});var mn=l(15009),h=l.n(mn),Wn=l(99289),k=l.n(Wn),D=l(67294),B=l(97753),T=l(92707),En=l(55753),On={"queryprofile-demo-0":{component:D.memo(D.lazy(k()(h()().mark(function nn(){var J,K,X,W;return h()().wrap(function(q){for(;;)switch(q.prev=q.next){case 0:return q.next=2,Promise.resolve().then(l.bind(l,92707));case 2:return J=q.sent,K=J.QueryProfile,q.next=6,Promise.resolve().then(l.bind(l,55753));case 6:return X=q.sent,W=X.DEMO,q.abrupt("return",{default:function(){return D.createElement(K,{isDemo:!0,outValue:JSON.parse(W),profileRef:"body"})}});case 9:case"end":return q.stop()}},nn)})))),asset:{type:"BLOCK",id:"queryprofile-demo-0",refAtomIds:["QueryProfile"],dependencies:{"index.jsx":{type:"FILE",value:`import { QueryProfile } from 'databend-profile-ui';
import { DEMO } from './demo';

export default () => (
  <QueryProfile isDemo={true} outValue={JSON.parse(DEMO)} profileRef={'body'} />
);`},"databend-profile-ui":{type:"NPM",value:"0.0.26"},"./demo.ts":{type:"FILE",value:l(45760).Z}},entry:"index.jsx"},context:{"./demo.ts":En,"databend-profile-ui":T,"/home/runner/work/databend-profile-ui/databend-profile-ui/src/QueryProfile/demo.ts":En},renderOpts:{compile:function(){var nn=k()(h()().mark(function K(){var X,W=arguments;return h()().wrap(function(q){for(;;)switch(q.prev=q.next){case 0:return q.next=2,l.e(335).then(l.bind(l,37335));case 2:return q.abrupt("return",(X=q.sent).default.apply(X,W));case 3:case"end":return q.stop()}},K)}));function J(){return nn.apply(this,arguments)}return J}()}},"queryprofile-demo-1":{component:D.memo(D.lazy(k()(h()().mark(function nn(){var J,K;return h()().wrap(function(W){for(;;)switch(W.prev=W.next){case 0:return W.next=2,Promise.resolve().then(l.bind(l,92707));case 2:return J=W.sent,K=J.TestProfile,W.abrupt("return",{default:function(){return D.createElement(K,{isDemo:!0})}});case 5:case"end":return W.stop()}},nn)})))),asset:{type:"BLOCK",id:"queryprofile-demo-1",refAtomIds:["QueryProfile"],dependencies:{"index.jsx":{type:"FILE",value:`import { TestProfile } from 'databend-profile-ui';

export default () => <TestProfile isDemo />;`},"databend-profile-ui":{type:"NPM",value:"0.0.26"}},entry:"index.jsx"},context:{"databend-profile-ui":T},renderOpts:{compile:function(){var nn=k()(h()().mark(function K(){var X,W=arguments;return h()().wrap(function(q){for(;;)switch(q.prev=q.next){case 0:return q.next=2,l.e(335).then(l.bind(l,37335));case 2:return q.abrupt("return",(X=q.sent).default.apply(X,W));case 3:case"end":return q.stop()}},K)}));function J(){return nn.apply(this,arguments)}return J}()}}}},55753:function(An,G,l){l.r(G),l.d(G,{DEMO:function(){return mn}});var mn=`{
